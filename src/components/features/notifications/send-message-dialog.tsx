...
import { Search, Send, Users, Mail, MessageSquare } from 'lucide-react'
...
export function SendMessageDialog({
  ...
  const availableTemplates = templates.filter((t) => t.type === messageType)
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                className="mt-2"
                maxLength={messageType === 'sms' ? 1000 : undefined}
              />
              {messageType === 'sms' && (
                <p className="text-xs text-muted-foreground mt-1">
                  {message.length}자 / 90자 권장
                </p>
              )}
            </div>
          </div>
