...
export function EventDetailModal({
  ...
  return (
    ...
    >
      <div
        className="bg-background rounded-2xl w-full max-w-sm shadow-2xl border border-border overflow-hidden flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        {/* 헤더 */}
        <div className="px-6 py-5 border-b border-border flex justify-between items-start bg-muted/50">
          <div className="flex flex-col gap-2">
            ...
            <h3 className="font-bold text-xl text-foreground leading-tight pr-4">
              {event.title}
            </h3>
          </div>
          <button
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground font-medium">일시</p>
              ...
              {event.all_day && (
                <p className="text-xs text-muted-foreground/70">~ {formatDateTime(endDate)}</p>
              )}
            </div>
          </div>
          ...
          {typeof event.meta?.location === 'string' && event.meta.location && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">장소</p>
                <p className="text-sm font-bold text-foreground">
                  {event.meta.location}
                </p>
              </div>
          ...
          {event.reminder_minutes != null && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">알림</p>
                <p className="text-sm font-bold text-foreground">
          ...
          {event.recurrence_rule && (
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">반복</p>
                <p className="text-sm font-bold text-foreground">
          ...
          {event.description && (
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs text-muted-foreground font-medium mb-1">상세 내용</p>
        ...
        <div className="p-4 border-t border-border bg-muted/50 flex gap-2">
          {onDelete && (
            <button
              ...
              className="p-3 bg-background border border-border text-red-500 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-200 transition-colors"
              title="삭제"
            >
              <Trash2 size={18} />
            </button>
          ...
          {onEdit && (
            <button
              ...
              className="flex-1 py-3 bg-foreground text-background rounded-xl font-bold text-sm hover:opacity-90 transition-colors flex items-center justify-center gap-2"
            >
              <Edit2 size={16} />
              수정하기
            </button>
