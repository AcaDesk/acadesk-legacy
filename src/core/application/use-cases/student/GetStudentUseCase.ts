...
import type { IStudentRepository, StudentFilters, FindStudentOptions } from '@core/domain/repositories/IStudentRepository'
import type { Student } from '@core/domain/entities/Student'
import type { StudentCode } from '@core/domain/value-objects/StudentCode'
