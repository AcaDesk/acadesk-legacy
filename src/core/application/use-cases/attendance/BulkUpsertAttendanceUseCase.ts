...
import type { AttendanceRepository, BulkAttendanceInput } from '@infra/db/repositories/attendance.repository'
import { ValidationError } from '@/lib/error-types'
import { bulkAttendanceSchema } from '@/core/types/attendance'
