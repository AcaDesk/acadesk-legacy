...
import type { AttendanceRepository, CreateSessionInput } from '@infra/db/repositories/attendance.repository'
import { ValidationError } from '@/lib/error-types'
import { createSessionSchema } from '@/core/types/attendance'
