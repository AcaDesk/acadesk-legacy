...
export class SupabaseExamScoreRepository implements IExamScoreRepository {
  ...
  async findById(id: string): Promise<ExamScore | null> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'findById', id })
      ...
      logError(error, { repository: 'SupabaseExamScoreRepository', method: 'findById' })
  ...
  async findByExamId(examId: string, filters?: ExamScoreFilters): Promise<ExamScore[]> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'findByExamId' })
  ...
  async findByStudentId(studentId: string): Promise<ExamScore[]> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'findByStudentId' })
  ...
  async findAll(tenantId: string, filters?: ExamScoreFilters, limit: number = 100): Promise<ExamScore[]> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'findAll' })
  ...
  async findByExamAndStudent(examId: string, studentId: string): Promise<ExamScore | null> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'findByExamAndStudent' })
        throw new DatabaseError('성적을 조회할 수 없습니다', error)
      }
  ...
  async save(examScore: ExamScore): Promise<ExamScore> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'save' })
  ...
  async saveBulk(examScores: ExamScore[]): Promise<ExamScore[]> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'saveBulk' })
  ...
  async delete(id: string): Promise<void> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'delete', id })
        throw new DatabaseError('성적을 삭제할 수 없습니다', error)
      }
    } catch (error) {
      if (error instanceof DatabaseError) throw error
      logError(error, { repository: 'SupabaseExamScoreRepository', method: 'delete' })
  ...
  async getStatsByExam(examId: string): Promise<ExamScoreStats> {
    try {
      ...
      logError(error, { repository: 'SupabaseExamScoreRepository', method: 'getStatsByExam' })
  ...
  async getStatsByStudent(studentId: string): Promise<ExamScoreStats> {
    try {
      ...
      logError(error, { repository: 'SupabaseExamScoreRepository', method: 'getStatsByStudent' })
      return this.emptyStats()
    }
  }
  ...
  async findLowPerformers(examId: string, threshold: number): Promise<ExamScore[]> {
    try {
      ...
      if (error) {
        logError(error, { repository: 'SupabaseExamScoreRepository', method: 'findLowPerformers' })
