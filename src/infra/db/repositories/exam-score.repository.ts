...
import type { IExamScoreRepository, ExamScoreFilters, ExamScoreStats } from '@core/domain/repositories/IExamScoreRepository'
import { ExamScore } from '@core/domain/entities/ExamScore'
