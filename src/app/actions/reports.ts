...
import { ReportType } from '@core/domain/entities/Report'
import { MessageChannel } from '@core/domain/messaging/IMessageProvider'
import { GenerateStudentReportUseCase } from '@core/application/use-cases/report/GenerateStudentReportUseCase'
import { SendReportUseCase } from '@core/application/use-cases/report/SendReportUseCase'
import { ReportRepository } from '@infra/db/repositories/report.repository'
import { MessageLogRepository } from '@infra/db/repositories/message-log.repository'
