  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        question: '성적 그래프 보기',
        answer:
          '학생 상세 페이지의 "성적" 탭에서 해당 학생의 과목별, 시간별 성적 추이를 그래프로 확인할 수 있습니다.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        question: '과제 검증하기',
        answer:
          '"TODO 관리 > 검증" 메뉴에서 학생들이 완료한 과제를 확인하고 검증할 수 있습니다. 여러 과제를 선택하여 일괄 검증도 가능합니다.',
      },
      {
        question: 'TODO 템플릿 사용하기',
        answer:
          '자주 배정하는 과제는 템플릿으로 저장하여 재사용할 수 있습니다. "템플릿 관리"에서 템플릿을 생성하고, 과제 추가 시 템플릿을 선택하면 빠르게 배정할 수 있습니다.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        question: '리포트 내용 수정',
        answer:
          '생성된 리포트의 "편집" 버튼을 통해 교사의 코멘트나 특이사항을 추가할 수 있습니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        question: '과목 추가 및 관리',
        answer:
          '"설정 > 과목 관리"에서 학원에서 사용하는 과목들을 등록하고 관리할 수 있습니다. 각 과목마다 색상을 지정하여 시각적으로 구분할 수 있습니다.',
      },
      {
        question: '알림 설정',
        answer:
          '"설정 > 알림 설정"에서 학생 출결, 과제 완료, 상담 예약 등 각종 이벤트에 대한 알림 설정을 변경할 수 있습니다.',
      },
    ],
  },
]
